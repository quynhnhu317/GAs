...
namespace TKB_THCS
{
    public partial class frmTKBGV : MetroFramework.Forms.MetroForm
    {
        ...
        //hiển thị lịch dạy tuwong ứng của giáo viên được chọn trên GridView
        private void LoadData(int rowIndex)
        {
            ...
            {
                Loading = true;
                //lấy giá trị của ô đầu tiên của hàng được chọn
        ...
        //load lại data mỗi khi 1 hàng trên GridView được chọn
        ...
        private void btnXuat_Click(object sender, EventArgs e)
        {
            ...
            if (fsave.FileName != "")
            {
                ...
                try
                {
                    ...
                    sheet.Cells[8, 1].Font.Name = "Times New Roman";
                    sheet.Cells[8, 1].Font.Size = 14;
                    sheet.Cells[8, 1].ColumnWidth = 12;
                    ...
                    sheet.Cells[8, 2].Font.Name = "Times New Roman";
                    sheet.Cells[8, 2].Font.Size = 14;
                    sheet.Cells[8, 2].ColumnWidth = 12;
                    ...
                    sheet.Cells[8, 3].Font.Name = "Times New Roman";
                    sheet.Cells[8, 3].Font.Size = 14;
                    sheet.Cells[8, 3].ColumnWidth = 12;
                    ...
                    sheet.Cells[8, 4].Font.Name = "Times New Roman";
                    sheet.Cells[8, 4].Font.Size = 14;
                    sheet.Cells[8, 4].ColumnWidth = 12;
                    ...
                    sheet.Cells[8, 5].Font.Name = "Times New Roman";
                    sheet.Cells[8, 5].Font.Size = 14;
                    sheet.Cells[8, 5].ColumnWidth = 12;
                    ...
                    sheet.Cells[8, 6].Font.Name = "Times New Roman";
                    sheet.Cells[8, 6].Font.Size = 14;
                    sheet.Cells[8, 6].ColumnWidth = 12;
                    ...
                    sheet.Cells[8, 7].Font.Name = "Times New Roman";
                    sheet.Cells[8, 7].Font.Size = 14;
                    sheet.Cells[8, 7].ColumnWidth = 12;
                    ...
                    sheet.Cells[2, 1].ColumnWidth = 12;
                    ...
                    sheet.Cells[2, 2].ColumnWidth = 12;
                    ...
                    sheet.Cells[2, 3].ColumnWidth = 12;
                    ...
                    sheet.Cells[2, 4].ColumnWidth = 12;
                    ...
                    sheet.Cells[2, 6].ColumnWidth = 12;
                    ...
                    sheet.Cells[2, 7].ColumnWidth = 12;
                    ...
                    for (int i = 1; i <= listTiet.Items.Count; i++)
                    {
                        ...
                        sheet.Cells[i + 2, 1].ColumnWidth = 12;
                    ...
                    for (int i = 1; i <= listBox1.Items.Count; i++)
                    {
                        ...
                        sheet.Cells[i + 2, 2].ColumnWidth = 12;
                    ...
                    for (int i = 1; i <= listBox2.Items.Count; i++)
                    {
                        ...
                        sheet.Cells[i + 2, 3].ColumnWidth = 12;
                    ...
                    for (int i = 1; i <= listBox3.Items.Count; i++)
                    {
                        ...
                        sheet.Cells[i + 2, 4].ColumnWidth = 12;
                    ...
                    for (int i = 1; i <= listBox4.Items.Count; i++)
                    {
                        ...
                        sheet.Cells[i + 2, 5].ColumnWidth = 12;
                    ...
                    for (int i = 1; i <= listBox5.Items.Count; i++)
                    {
                        ...
                        sheet.Cells[i + 2, 6].ColumnWidth = 12;
                    ...
                    for (int i = 1; i <= listBox6.Items.Count; i++)
                    {
                        ...
                        sheet.Cells[i + 2, 7].ColumnWidth = 12;
                    ...
                    for (int i = 1; i <= listTiet.Items.Count; i++)
                    {
                        ...
                        sheet.Cells[i + 8, 1].Font.Name = "Times New Roman";
                        sheet.Cells[i + 8, 1].Font.Size = 14;
                        sheet.Cells[i + 8, 1].ColumnWidth = 12;
                    ...
                    for (int i = 1; i <= listBox7.Items.Count; i++)
                    {
                        ...
                        sheet.Cells[i + 8, 2].Font.Name = "Times New Roman";
                        sheet.Cells[i + 8, 2].Font.Size = 14;
                        sheet.Cells[i + 8, 2].ColumnWidth = 12;
                    ...
                    for (int i = 1; i <= listBox8.Items.Count; i++)
                    {
                        ...
                        sheet.Cells[i + 8, 3].Font.Name = "Times New Roman";
                        sheet.Cells[i + 8, 3].Font.Size = 14;
                        sheet.Cells[i + 8, 3].ColumnWidth = 12;
                    ...
                    for (int i = 1; i <= listBox9.Items.Count; i++)
                    {
                        ...
                        sheet.Cells[i + 8, 4].Font.Name = "Times New Roman";
                        sheet.Cells[i + 8, 4].Font.Size = 14;
                        sheet.Cells[i + 8, 4].ColumnWidth = 12;
                    ...
                    for (int i = 1; i <= listBox10.Items.Count; i++)
                    {
                        ...
                        sheet.Cells[i + 8, 5].Font.Name = "Times New Roman";
                        sheet.Cells[i + 8, 5].Font.Size = 14;
                        sheet.Cells[i + 8, 5].ColumnWidth = 12;
                    ...
                    for (int i = 1; i <= listBox11.Items.Count; i++)
                    {
                        ...
                        sheet.Cells[i + 8, 6].Font.Name = "Times New Roman";
                        sheet.Cells[i + 8, 6].Font.Size = 14;
                        sheet.Cells[i + 8, 6].ColumnWidth = 12;
                    ...
                    for (int i = 1; i <= listBox12.Items.Count; i++)
                    {
                        ...
                        sheet.Cells[i + 8, 7].Font.Name = "Times New Roman";
                        sheet.Cells[i + 8, 7].Font.Size = 14;
                        sheet.Cells[i + 8, 7].ColumnWidth = 12;
        ...
        //hiện tên giáo viên khi click vào ô GridView
        private void gridGV_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            if (gridGV.Rows.Count > 0)
            {
                try
                {
                    ...
                    lbMon.Text = "Môn: " + gridGV.SelectedRows[0].Cells[2].Value.ToString();
                    if (lbGV.Text == "")
                    {
                        btnXuat.Enabled = false;
                    }
